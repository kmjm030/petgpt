...
<style>
                ...
                .sticky-footer-buttons button {
                    flex-grow: 1;
                    padding: 5px 15px; /* 위아래 padding 더 줄임 */
                    font-size: 16px;
                    border-radius: 5px;
                    cursor: pointer;
                }
                ...
                #add-to-wishlist-btn {
                    ...
                    color: #333;
                    flex-grow: 0;
                    padding: 5px 20px; /* 위아래 padding 더 줄임 */
                }
    ...
    function toggleContent(id) {
        ...
        if (contentRow.style.display === "none" || contentRow.style.display === "") {
            ...
            <section class="shop-details">
                <div id="product-details-data" data-item-key="${item.itemKey}" style="display: none;"></div> <%-- Moved
                    itemKey div here for cleaner structure --%>
                                                    ...
                                                    <div class="product__details__tab__content">
                                                        <%-- 상품 설명 동적 표시 필요 --%>
                                                            <p class="note">Nam tempus turpis at metus scelerisque
                                                                ...
                                                                lobortis des mollis
                                                                ut risus. Sedcus faucibus an sullamcorper mattis
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg"
                                        data-setbg="<c:url value='/img/product/${relatedItem.itemImg1}'/>">
                                        <ul class="product__hover">
                                            <li><a href="#"><img src="<c:url value='/img/icon/heart.png'/>" alt=""></a>
                                            </li>
                                            <li><a href="<c:url value='/shop/details?itemKey=${relatedItem.itemKey}'/>"><img
                                                        src="<c:url value='/img/icon/search.png'/>" alt=""></a></li>
                                        </ul>
                                    </div>
                                    <div class="product__item__text">
                                        <h6>
                                            <c:out value="${relatedItem.itemName}" />
                                        </h6>
                                        <a href="#" class="add-cart" data-item-key="${relatedItem.itemKey}">+ Add To
                                            Cart</a>
                                        <h5>
                                            <fmt:formatNumber value="${relatedItem.itemPrice}" type="currency"
                                                currencySymbol="₩" />
                                        </h5>
                                    </div>
                                </div>
