...
<script>
  const qna_add = {
    ...
    send:function(){
      ...
      $('#review_add_form').attr('action','<c:url value="/review/addimpl"/>');
    ...
    <div class="row">
      ...
      <div class="col-lg-9 container mt-3 review-box">
        ...
        <form id="review_add_form" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-lg-12">
            <img src="<c:url value='/img/product/${item.itemImg1}'/>" width="300" style="border-radius:20px; display: block; margin: 0 auto;"/>
            </div>
          </div>
