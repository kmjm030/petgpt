<%@ page pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <!-- Data for JS -->
      <div id="review-detail-data" style="display: none;" data-context-path="${pageContext.request.contextPath}">
      </div>
            ...
            <%-- 옆 사이드 바(마이페이지 카테고리) --%>
              ...
              <%-- 회원 정보 --%>
                <div class="col-lg-9 container mt-3 review-box">
                  <h4><strong>📝 리뷰 상세페이지</strong></h4>
                  <h6 class="checkout__title"></h6>
                  <form id="review_update_form" enctype="multipart/form-data">
                    <%-- 문의종류 --%>
                      <div class="row">
                        <div class="col-lg-12">
                          <img src="<c:url value='/img/product/${board.item.itemImg1}'/>" width="300"
                      ...
                      <div class="row">
                        <div class="form-group col-md-12">
                          <div class="checkout__input">
                            ...
                            <textarea placeholder="리뷰를 작성하세요." id="boardContent"
