                                ...
                                <form id="addr_update_form">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <div class="checkout__input">
                                                ...
                                                <input type="text" value="${address.addrName}" id="addrName"
                                                    name="addrName">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="checkout__input">
                                                ...
                                                <input type="tel" value="${address.addrTel}" id="addrTel"
                                                    name="addrTel">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="checkout__input">
                                            ...
                                            <div class="checkout__input">
                                                <input type="text" id="sample6_postcode" value="${address.addrHomecode}"
                                                    name="addrHomecode">
                                                <input type="button" onclick="sample6_execDaumPostcode()"
                                                    value="우편번호 찾기"><br>
                                                <input type="text" id="sample6_address" value="${address.addrAddress}"
                                                    name="addrAddress"><br>
                                                <input type="text" id="sample6_detailAddress"
                                                    value="${address.addrDetail}" name="addrDetail">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <select class="form-select" id="optionSelect" name="addrReq">
                                                <option value="문앞" ${address.addrReq=='문앞' ? 'selected' : '' }>문앞에 두고 연락
                                                    남겨주세요.</option>
                                                <option value="경비실" ${address.addrReq=='경비실' ? 'selected' : '' }>경비실 앞에
                                                    놔주세요.</option>
                                                <option value="우편함" ${address.addrReq=='우편함' ? 'selected' : '' }>우편함 앞에
                                                    놔주세요.</option>
                                                <option value="연락" ${address.addrReq=='연락' ? 'selected' : '' }>배송 전 연락
                                                    바랍니다.</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check form-switch form-group">
                                        <input class="form-check-input" type="checkbox" id="addrDef" name="addrDef"
                                            value="Y" ${address.addrDef=='Y' ? 'checked' : '' }>
