...
<script>
    const cust_detail = {
        ...
        check:function(){
            ...
            let c = confirm('배송지 정보를 수정하시겠습니까?');
            if (c == true) {
                this.send();
            }
        },
        send:function(){
            $('#addr_update_form').attr('method','post');
            $('#addr_update_form').attr('action','<c:url value="/address/updateimpl"/>');
            $('#addr_update_form').submit();
        },
    }
    $(function(){
        cust_detail.init();
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            <div class="checkout__input">
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="text" id="sample6_address" value="${address.addrAddress}" name="addrAddress"><br>
                                    <input type="text" id="sample6_detailAddress" value="${address.addrDetail}" name="addrDetail">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <select class="form-select" id="optionSelect" name="addrReq">
                                    <option value="문앞" ${address.addrReq == '문앞' ? 'selected' : ''}>문앞에 두고 연락 남겨주세요.</option>
                                    <option value="경비실" ${address.addrReq == '경비실' ? 'selected' : ''}>경비실 앞에 놔주세요.</option>
                                    <option value="우편함" ${address.addrReq == '우편함' ? 'selected' : ''}>우편함 앞에 놔주세요.</option>
                                    <option value="연락" ${address.addrReq == '연락' ? 'selected' : ''}>배송 전 연락 바랍니다.</option>
                                </select>
                            </div>
                        </div>
                        <br/>
                    ...
                    <div class="checkout__order">
                        <button class="site-btn" id="addr_update_btn">수정하기</button>
                    </div>
                </div>
        </div>
    </div>
