<%@ page pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <!-- Data for JS -->
      <div id="order-data" style="display: none;" data-context-path="${pageContext.request.contextPath}">
      </div>
                    ...
                    <tbody>
                      <c:forEach var="c" items="${orderList}">
                        <tr>
                          ...
                          <td>
                            <fmt:formatDate value="${c.orderDate}" pattern="yyyy-MM-dd HH:mm" />
                          </td>
                          <td>
                            <button id="order_detail_btn"
                              onclick="location.href='<c:url value='/checkout/detail?orderKey='/>${c.orderKey}'">상세보기</button>
                          </td>
                        </tr>
                      </c:forEach>
                    </tbody>
